...
class Status extends ImmutablePureComponent {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (nextProps.status && nextProps.status.get('id') !== this.state.loadedStatusId) {
      this.setState({ showMedia: defaultMediaVisibility(nextProps.status), loadedStatusId: nextProps.status.get('id'), showQuoteMedia: defaultMediaVisibility(nextProps.status.get('quote', null)) });
    }
  }
