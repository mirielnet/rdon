...
import { autoPlayGif, me, show_followed_by, follow_button_to_list_adder } from 'mastodon/initial_state';
...
class Header extends ImmutablePureComponent {
  ...
  render () {
    ...
    const subscribing      = account.getIn(['relationship', 'subscribing'], new ImmutableMap).size > 0;
    const subscribing_home = account.getIn(['relationship', 'subscribing', '-1'], new ImmutableMap).size > 0;
